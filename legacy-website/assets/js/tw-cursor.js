...
if ($("body").not(".is-mobile").hasClass("tw-magic-cursor")) {
    ...
    $("[data-cursor]").each(function() {
        $(this).on("mouseenter", function() {
            ...
            gsap.to(ball, { duration: 0.3, yPercent: -75, width: 90, height: 90, opacity: 1, borderWidth: 1, zIndex:1, backdropFilter: "blur(14px)",
            backgroundColor: "#ff6644", boxShadow: "0px 1px 3px 0px rgba(18, 20, 32, 0.14)"});
